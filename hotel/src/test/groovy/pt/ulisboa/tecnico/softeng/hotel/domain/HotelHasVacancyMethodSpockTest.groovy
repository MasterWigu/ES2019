...
class HotelHasVacancyMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    @Override
    def populate4Test() {
        hotel = new Hotel("XPTO123", "Paris", NIF_HOTEL, "IBAN", 20000L, 30000L, new Processor(new BankInterface(), new TaxInterface()))
    ...
    def "no vacancy empty room set"() {
        ...
        def otherHotel = new Hotel("XPTO124", "Paris Germain", "NIF2", "IBAN", 25000L, 35000L, new Processor(new BankInterface(), new TaxInterface()))
