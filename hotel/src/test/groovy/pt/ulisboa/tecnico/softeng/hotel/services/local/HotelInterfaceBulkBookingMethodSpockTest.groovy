...
class HotelInterfaceBulkBookingMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def populate4Test() {
        ...
        hotel = new Hotel('XPTO123', 'Paris', 'NIF', 'IBAN', 20000L, 30000L, new Processor(bankInterfaceOne, taxInterfaceOne))
        ...
        hotel = new Hotel('XPTO124', 'Paris', 'NIF2', 'IBAN2', 25000L, 35000L, new Processor(bankInterfaceTwo, taxInterfaceTwo))
        new Room(hotel, '01', Type.DOUBLE)
        new Room(hotel, '02', Type.SINGLE)
        new Room(hotel, '03', Type.DOUBLE)
        new Room(hotel, '04', Type.SINGLE)
    ...
    def 'no rooms'() {
        ...
        hotel = new Hotel('XPTO124', 'Paris', 'NIF', 'IBAN', 27000L, 37000L, new Processor(Mock(BankInterface), Mock(TaxInterface)))
