...
class HotelPersistenceSpockTest extends SpockPersistenceTestAbstractClass {
    ...
    def whenCreateInDatabase() {
        def hotel = new Hotel(HOTEL_CODE, HOTEL_NAME, HOTEL_NIF, HOTEL_IBAN, 10000L, 20000L, new Processor(new BankInterface(), new TaxInterface()))
    ...
    def thenAssert() {
        ...
        assert hotel.getPriceSingle() == 10000L
        assert hotel.getPriceDouble() == 20000L
        ...
        assert booking.getPrice() == 80000L
