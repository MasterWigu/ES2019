...
class RentVehicleStateMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def 'successRentVehicleCar'() {
        given: 'mocking of renting a car succeeds and returns value rentingData'
        carInterface.rentCar(RENTINGTYPE, DRIVING_LICENSE, BROKER_NIF_AS_BUYER, BROKER_IBAN,
	...
	def 'successRentVehicleMotorcycle'() {
		adventure.setRentingType(CarInterface.Type.MOTORCYCLE)
		given: 'mocking of renting a car succeeds and returns value rentingData'
    ...
    def 'exceptions rentCar'() {
        ...
        iterations * carInterface.rentCar(RENTINGTYPE, DRIVING_LICENSE, BROKER_NIF_AS_BUYER, BROKER_IBAN,
	...
	@Unroll('#label (rentCar): adventure in state #adventure_state ')
	def 'exceptions rentCar with Motorcycle'() {
		adventure.setRentingType(CarInterface.Type.MOTORCYCLE)
		given: 'rentCar fails #iterations time(s)'
	...
	def 'twoRemoteAccessExceptionOneSuccessMotorcycle'() {
		adventure.setRentingType(CarInterface.Type.MOTORCYCLE)
	...
	def 'oneRemoteAccessExceptionOneCarExceptionMotorcycle'() {
		adventure.setRentingType(CarInterface.Type.MOTORCYCLE)
		given: 'renting a car fails with a remote exception followed by a car exception'
		carInterface.rentCar(CarInterface.Type.MOTORCYCLE, DRIVING_LICENSE, BROKER_NIF_AS_BUYER, BROKER_IBAN,
				BEGIN, END, _) >>
