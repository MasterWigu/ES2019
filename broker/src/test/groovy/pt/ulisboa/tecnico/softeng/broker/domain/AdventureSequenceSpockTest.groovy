...
class AdventureSequenceSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def 'success sequence with car #car, hotel #hotel'() {
        ...
        def adventure = new Adventure(broker, ROOMTYPE, ARRIVAL, end, client, MARGIN, car, RENTINGTYPE)
    ...
    def 'unsuccess sequence fail activity'() {
        given: 'an adventure'
        def adventure = new Adventure(broker, ROOMTYPE, ARRIVAL, DEPARTURE, client, MARGIN, RENTINGTYPE)
    ...
    def 'unsuccess sequence fail car'() {
        ...
        def adventure = new Adventure(broker, ROOMTYPE, ARRIVAL, ARRIVAL, client, MARGIN, true, RENTINGTYPE)
        and: 'an activity reservation'
        activityInterface.reserveActivity(_) >> bookingActivityData
        and: 'a car exception'
    ...
    def 'unsuccess sequence fail payment'() {
        given: 'an adventure with rent vehicle'
        def adventure = new Adventure(broker, ROOMTYPE, ARRIVAL, DEPARTURE, client, MARGIN, true, RENTINGTYPE)
        and: 'an activity reservation'
        activityInterface.reserveActivity(_) >> bookingActivityData
        and: 'a room booking'
        hotelInterface.reserveRoom(_) >> bookingRoomData
